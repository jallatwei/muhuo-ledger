...
BEGIN
  ...
  WHERE ab."entityId" = p_entity_id AND ab."periodId" = p_period_id
    AND (ab."debitOccurred", ab."creditOccurred") IS DISTINCT FROM (
      SELECT COALESCE(SUM(CASE WHEN l.direction = 'DEBIT' THEN l.amount ELSE 0 END), 0),
